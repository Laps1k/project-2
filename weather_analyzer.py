import requests
from project.location_parser import get_location_key_by_city
from project.secretka import accuweather_api_key


def check_bad_weather(temp, wind_speed_kmh, precipitation_prob):
